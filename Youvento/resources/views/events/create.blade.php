...
@section('content')
    <div class="max-w-3xl mx-auto mt-10 bg-white p-6 shadow-md rounded-lg">
        <h1 class="text-2xl font-semibold text-gray-800 mb-4">Créer un Event</h1>
        ...
        <form action="{{ route('events.store') }}" method="POST">
            ...
            <div class="mb-4">
                <label for="title" class="block text-gray-700 font-medium">Nom du Event</label>
            ...
            <div class="flex justify-between items-center">
                <a href="{{ route('events.index') }}" class="text-blue-500 hover:underline">← Retour</a>
